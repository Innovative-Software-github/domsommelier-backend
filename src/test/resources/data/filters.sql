...
insert into filter (id, name, field, product_category, type) values ('b210deae-e49e-4889-967b-8d2b7934f853', 'География', 'countries', 'wine', 'multi_select');
...
insert into filter (id, name, field, product_category, type) values ('02ddd7cf-49f2-45d2-a2e5-a0d3d115af02', 'Особенности', 'features', 'wine', 'multi_select');
...
-- География (multi_select)
insert into filter (id, name, field, product_category, type) values ('d879d38d-e7ce-4b30-bc88-c1e9d1aab413', 'География', 'countries', 'spirit', 'multi_select');
...
insert into multi_select_filter (id) values ('9443537a-433c-447d-845d-17b3006e2149');

-- Особенности (multi_select)
insert into filter (id, name, field, product_category, type) values ('09f3ad68-6bfd-4dbc-b809-8ba91e4ba023', 'Особенности', 'features', 'spirit', 'multi_select');
...
-- География (multi_select)
insert into filter (id, name, field, product_category, type) values ('caa1eb21-4b02-4a4f-81f8-7e2fb0723db4', 'География', 'countries', 'accessories', 'multi_select');
...
-- Особенности (multi_select)
insert into filter (id, name, field, product_category, type) values ('eedbce23-1eb0-4c6f-a4e6-4b2e5ea8e2a7', 'Особенности', 'features', 'accessories', 'multi_select');
...
-- Субкатегория (multi_select)
insert into filter (id, name, field, product_category, type) values ('0ebd7e0f-cb8d-4a2e-83af-3d6d6e652478', 'Субкатегория', 'subcategory', 'snack', 'multi_select');
...
-- География (multi_select)
insert into filter (id, name, field, product_category, type) values ('ef50bee7-0608-4150-b3fc-2716932b4f1b', 'География', 'countries', 'snack', 'multi_select');
...
-- Субкатегория (multi_select)
insert into filter (id, name, field, product_category, type) values ('3a82f3e6-6a98-44a9-b687-88b0b354e11b', 'Субкатегория', 'subcategory', 'low_alcohol', 'multi_select');
insert into multi_select_filter (id) values ('3a82f3e6-6a98-44a9-b687-88b0b354e11b');

-- География (multi_select)
insert into filter (id, name, field, product_category, type) values ('092ebf93-af16-4f5a-8c7b-72e0cc0f5950', 'География', 'countries', 'low_alcohol', 'multi_select');
insert into multi_select_filter (id) values ('092ebf93-af16-4f5a-8c7b-72e0cc0f5950');

-- Крепость (range)
insert into filter (id, name, field, product_category, type) values ('b68b6d4c-1f10-4e8b-818a-2064d1d19cb5', 'Крепость', 'strength', 'low_alcohol', 'range');
...
insert into filter (id, name, field, product_category, type) values ('5b555b5a-2e91-4834-8c8a-4d9e5d237c80', 'Субкатегория', 'subcategory', 'champagne_and_sparkling', 'multi_select');
insert into multi_select_filter (id) values ('5b555b5a-2e91-4834-8c8a-4d9e5d237c80');

-- География (multi_select)
insert into filter (id, name, field, product_category, type) values ('8fc2deeb-25c1-4cc7-8397-63f0d8c1b1ef', 'География', 'countries', 'champagne_and_sparkling', 'multi_select');
