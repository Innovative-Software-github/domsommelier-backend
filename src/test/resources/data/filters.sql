...
-- Тип (multi_select)
insert into filter (id, name, field, product_category, type) values ('0b11297e-508d-485a-8989-094660207863', 'Тип', 'type', 'wine', 'multi_select');
insert into multi_select_filter (id) values ('0b11297e-508d-485a-8989-094660207863');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('d879d38d-e7ce-4b30-bc88-c1e9d1aab413', 'ITALY', 'Италия');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('d879d38d-e7ce-4b30-bc88-c1e9d1aab413', 'RUSSIA', 'Россия');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('d879d38d-e7ce-4b30-bc88-c1e9d1aab413', 'FRANCE', 'Франция');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('e8ea11c1-412e-444d-ac9f-8bac813fcdfa', 'pulltex', 'Pulltex');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('e8ea11c1-412e-444d-ac9f-8bac813fcdfa', 'prestigio', 'Prestigio');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('e8ea11c1-412e-444d-ac9f-8bac813fcdfa', 'onegin', 'Онегин');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('09f3ad68-6bfd-4dbc-b809-8ba91e4ba023', 'gift_wrapping', 'Подарочный набор');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('09f3ad68-6bfd-4dbc-b809-8ba91e4ba023', 'сollection', 'Коллекционное');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('caa1eb21-4b02-4a4f-81f8-7e2fb0723db4', 'ITALY', 'Италия');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('caa1eb21-4b02-4a4f-81f8-7e2fb0723db4', 'RUSSIA', 'Россия');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('caa1eb21-4b02-4a4f-81f8-7e2fb0723db4', 'FRANCE', 'Франция');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('e4e9d3b2-5a91-4ecd-8c31-4e7281e4b2ce', 'pulltex', 'Pulltex');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('e4e9d3b2-5a91-4ecd-8c31-4e7281e4b2ce', 'prestigio', 'Prestigio');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('e4e9d3b2-5a91-4ecd-8c31-4e7281e4b2ce', 'onegin', 'Онегин');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('eedbce23-1eb0-4c6f-a4e6-4b2e5ea8e2a7', 'gift_wrapping', 'Подарочный набор');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('eedbce23-1eb0-4c6f-a4e6-4b2e5ea8e2a7', 'сollection', 'Коллекционное');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('3a82f3e6-6a98-44a9-b687-88b0b354e11b', 'vermouth', 'Вермут');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('3a82f3e6-6a98-44a9-b687-88b0b354e11b', 'aperitifs', 'Аперитив');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('3a82f3e6-6a98-44a9-b687-88b0b354e11b', 'tinctures', 'Настойки');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('092ebf93-af16-4f5a-8c7b-72e0cc0f5950', 'FRANCE', 'Франция');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('092ebf93-af16-4f5a-8c7b-72e0cc0f5950', 'ITALY', 'Италия');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('092ebf93-af16-4f5a-8c7b-72e0cc0f5950', 'RUSSIA', 'Россия');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('092ebf93-af16-4f5a-8c7b-72e0cc0f5950', 'SPAIN', 'Испания');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('092ebf93-af16-4f5a-8c7b-72e0cc0f5950', 'GERMANY', 'Германия');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('b9eea026-7ab1-4194-a417-7ea6f4610c5e', 'campari', 'Campari');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('b9eea026-7ab1-4194-a417-7ea6f4610c5e', 'martini', 'Martini');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('b9eea026-7ab1-4194-a417-7ea6f4610c5e', 'aperol', 'Aperol');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('b96132da-ef6d-4349-bb96-0d3f4b2b5016', '0.5', '0,5 л');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('b96132da-ef6d-4349-bb96-0d3f4b2b5016', '0.7', '0,7 л');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('b96132da-ef6d-4349-bb96-0d3f4b2b5016', '1', '1 л');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('b96132da-ef6d-4349-bb96-0d3f4b2b5016', 'other', 'Другой');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('5b555b5a-2e91-4834-8c8a-4d9e5d237c80', 'champagne', 'Шампанское');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('5b555b5a-2e91-4834-8c8a-4d9e5d237c80', 'sparkling', 'Игристое');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('5b555b5a-2e91-4834-8c8a-4d9e5d237c80', 'prosecco', 'Проссеко');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('8fc2deeb-25c1-4cc7-8397-63f0d8c1b1ef', 'FRANCE', 'Франция');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('8fc2deeb-25c1-4cc7-8397-63f0d8c1b1ef', 'ITALY', 'Италия');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('8fc2deeb-25c1-4cc7-8397-63f0d8c1b1ef', 'RUSSIA', 'Россия');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('8fc2deeb-25c1-4cc7-8397-63f0d8c1b1ef', 'SPAIN', 'Испания');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('8fc2deeb-25c1-4cc7-8397-63f0d8c1b1ef', 'GERMANY', 'Германия');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('c098ed6e-8a3d-4efe-8a09-f512d1c7f8e6', 'brut_nature', 'Brut Nature');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('c098ed6e-8a3d-4efe-8a09-f512d1c7f8e6', 'extra_brut', 'Extra Brut');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('c098ed6e-8a3d-4efe-8a09-f512d1c7f8e6', 'brut', 'Brut');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('c098ed6e-8a3d-4efe-8a09-f512d1c7f8e6', 'extra_dry', 'Extra Dry');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('c098ed6e-8a3d-4efe-8a09-f512d1c7f8e6', 'demi_sec', 'Demi-Sec');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('c098ed6e-8a3d-4efe-8a09-f512d1c7f8e6', 'doux', 'Doux');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('c2bcfa4e-912e-4ccd-b14c-3fae5fc1e638', 'moet_chandon', 'Moet & Chandon');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('c2bcfa4e-912e-4ccd-b14c-3fae5fc1e638', 'perrier_jouet', 'Perrier-Jouet');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('c2bcfa4e-912e-4ccd-b14c-3fae5fc1e638', 'castelvecchio', 'Castelvecchio');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('e6de4592-ea17-4671-b901-ddcd774e64c7', 'WHITE', 'Белое');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('e6de4592-ea17-4671-b901-ddcd774e64c7', 'PINK', 'Розовое');
...
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('0b06e9b7-22d4-46e1-bdcd-1de905d274be', '0.5', '0,5 л');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('0b06e9b7-22d4-46e1-bdcd-1de905d274be', '0.7', '0,7 л');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('0b06e9b7-22d4-46e1-bdcd-1de905d274be', '1', '1 л');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('0b06e9b7-22d4-46e1-bdcd-1de905d274be', '1.75', '1,75 л');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('0b06e9b7-22d4-46e1-bdcd-1de905d274be', 'other', 'Другой');

-- Особенности (multi_select)
insert into filter (id, name, field, product_category, type) values ('9cda7ec3-5fc7-4404-9ce3-6aeae90cabf2', 'Особенности', 'feature', 'champagne_and_sparkling', 'multi_select');
insert into multi_select_filter (id) values ('9cda7ec3-5fc7-4404-9ce3-6aeae90cabf2');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('9cda7ec3-5fc7-4404-9ce3-6aeae90cabf2', 'gift_wrapping', 'Подарочный набор');
--insert into multi_select_filter_option (multi_select_filter_id, val, label) values ('9cda7ec3-5fc7-4404-9ce3-6aeae90cabf2', 'сollection', 'Коллекционное');
