...
-- Цвет (multi_select)
insert into filter (id, name, product_category, type) values ('2d2bae7f-2924-4d1e-b0ad-94c1eb979921', 'Цвет', 'wine', 'multi_select');
...
insert into filter (id, name, product_category, type) values ('b210deae-e49e-4889-967b-8d2b7934f853', 'География', 'wine', 'multi_select');
...
insert into filter (id, name, product_category, type) values ('818fda71-375b-4ef8-9c47-1ef38e92bd68', 'Сорт винограда', 'wine', 'multi_select');
...
insert into filter (id, name, product_category, type) values ('abf59578-f3d8-46e6-99d0-4964ce34ab29', 'Содержание сахара', 'wine', 'multi_select');
...
insert into filter (id, name, product_category, type) values ('e1913a59-549a-4cfd-830b-153b7ebf2f55', 'Производитель', 'wine', 'multi_select');
...
-- Объем (multi_select)
insert into filter (id, name, product_category, type) values ('bdf0c025-205e-41c5-93ec-1274de945388', 'Объем', 'wine', 'multi_select');
...
insert into filter (id, name, product_category, type) values ('02ddd7cf-49f2-45d2-a2e5-a0d3d115af02', 'Особенности', 'wine', 'multi_select');
...
-- География (multi_select)
insert into filter (id, name, product_category, type) values ('d879d38d-e7ce-4b30-bc88-c1e9d1aab413', 'География', 'spirit', 'multi_select');
...
-- Производитель (multi_select)
insert into filter (id, name, product_category, type) values ('e8ea11c1-412e-444d-ac9f-8bac813fcdfa', 'Производитель', 'spirit', 'multi_select');
...
-- Особенности (multi_select)
insert into filter (id, name, product_category, type) values ('09f3ad68-6bfd-4dbc-b809-8ba91e4ba023', 'Особенности', 'spirit', 'multi_select');
...
-- География (multi_select)
insert into filter (id, name, product_category, type) values ('caa1eb21-4b02-4a4f-81f8-7e2fb0723db4', 'География', 'accessories', 'multi_select');
...
-- Производитель (multi_select)
insert into filter (id, name, product_category, type) values ('e4e9d3b2-5a91-4ecd-8c31-4e7281e4b2ce', 'Производитель', 'accessories', 'multi_select');
...
-- Особенности (multi_select)
insert into filter (id, name, product_category, type) values ('eedbce23-1eb0-4c6f-a4e6-4b2e5ea8e2a7', 'Особенности', 'accessories', 'multi_select');
...
insert into filter (id, name, product_category, type) values ('0ebd7e0f-cb8d-4a2e-83af-3d6d6e652478', 'Категория', 'snack', 'multi_select');
...
insert into filter (id, name, product_category, type) values ('c55d7baa-15fc-4930-acee-32234cefcdc9', 'Подбор к напиткам', 'snack', 'multi_select');
...
-- География (multi_select)
insert into filter (id, name, product_category, type) values ('ef50bee7-0608-4150-b3fc-2716932b4f1b', 'География', 'snack', 'multi_select');
...
-- Производитель (multi_select)
insert into filter (id, name, product_category, type) values ('6acab7b2-870a-442c-804e-963a39c5a860', 'Производитель', 'snack', 'multi_select');
...
-- Особенности (multi_select)
insert into filter (id, name, product_category, type) values ('b6bd99c3-ca75-4864-ab11-38f7ad0eef09', 'Особенности', 'snack', 'multi_select');
...
-- Категория (multi_select)
insert into filter (id, name, product_category, type) values ('3a82f3e6-6a98-44a9-b687-88b0b354e11b', 'Категория', 'low_alcohol', 'multi_select');
...
-- География (multi_select)
insert into filter (id, name, product_category, type) values ('092ebf93-af16-4f5a-8c7b-72e0cc0f5950', 'География', 'low_alcohol', 'multi_select');
...
-- Производитель (multi_select)
insert into filter (id, name, product_category, type) values ('b9eea026-7ab1-4194-a417-7ea6f4610c5e', 'Производитель', 'low_alcohol', 'multi_select');
...
-- Объем (multi_select)
insert into filter (id, name, product_category, type) values ('b96132da-ef6d-4349-bb96-0d3f4b2b5016', 'Объем', 'low_alcohol', 'multi_select');
...
-- Категория (multi_select)
insert into filter (id, name, product_category, type) values ('5b555b5a-2e91-4834-8c8a-4d9e5d237c80', 'Категория', 'champagne_and_sparkling', 'multi_select');
...
-- География (multi_select)
insert into filter (id, name, product_category, type) values ('8fc2deeb-25c1-4cc7-8397-63f0d8c1b1ef', 'География', 'champagne_and_sparkling', 'multi_select');
...
-- Содержание сахара (multi_select)
insert into filter (id, name, product_category, type) values ('c098ed6e-8a3d-4efe-8a09-f512d1c7f8e6', 'Содержание сахара', 'champagne_and_sparkling', 'multi_select');
...
-- Производитель (multi_select)
insert into filter (id, name, product_category, type) values ('c2bcfa4e-912e-4ccd-b14c-3fae5fc1e638', 'Производитель', 'champagne_and_sparkling', 'multi_select');
...
-- Цвет (multi_select)
insert into filter (id, name, product_category, type) values ('e6de4592-ea17-4671-b901-ddcd774e64c7', 'Цвет', 'champagne_and_sparkling', 'multi_select');
...
-- Объем (multi_select)
insert into filter (id, name, product_category, type) values ('0b06e9b7-22d4-46e1-bdcd-1de905d274be', 'Объем', 'champagne_and_sparkling', 'multi_select');
...
-- Особенности (multi_select)
insert into filter (id, name, product_category, type) values ('9cda7ec3-5fc7-4404-9ce3-6aeae90cabf2', 'Особенности', 'champagne_and_sparkling', 'multi_select');
