...
insert into product (id, article, name, quantity, initial_price, price, category_id, country_id) values ('293b85d0-f739-4856-a09b-8495f2157e4d', 'product1', 'product1', 100, 1000, 1500, 'white', 'france');
insert into product (id, article, name, quantity, initial_price, price, category_id, country_id) values ('ccfe12c7-2a16-4482-9c5b-ca57260fc475', 'product2', 'product2', 100, 20000, 20100, 'red', 'usa');
insert into product (id, article, name, quantity, initial_price, price, category_id, country_id) values ('f3e364ff-b656-44a3-a16e-2263e560345c', 'product3', 'product3', 400, 5000, 7500, 'dry', 'russia');
